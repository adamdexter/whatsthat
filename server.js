...
app.post('/api/draft', (req, res) => {
  const allowed = ['template', 'sheetUrl', 'tabName', 'delayMinMs', 'delayMaxMs', 'filters', 'contactsCache', 'selectedIds', 'previewId', 'activeTab', 'layout', 'columnKinds', 'hideUnselected', 'columnOrder', 'hideNumber'];
  const patch = {};
